                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" scope="col">فیلتر</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.product.value',$product->id) }}" class="btn btn-outline-info">فیلتر </a>
                                </td>{{-- فیلتر --}}
                                ...
                                <td class="text-center">{{-- ادیت و دیلیت --}}
                                    <div class="action-btns">
                                        ...
                                        <a href="{{ route('admin.product.create') }}?p_id={{ $product->id }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit">
