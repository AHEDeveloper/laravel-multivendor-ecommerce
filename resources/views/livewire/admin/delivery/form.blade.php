            ...
            <div class="widget-content widget-content-area">
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">نام روش ارسال</label>
                            ...
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">قیمت روش ارسال</label>
                                <input type="text" class="form-control" name="price" wire:model='price' id="formGroupExampleInput">
                            </div>
                    ...
                    <button style="height: 50px" type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light">
                         <span wire:loading.remove >ثبت روش ارسال</span>
