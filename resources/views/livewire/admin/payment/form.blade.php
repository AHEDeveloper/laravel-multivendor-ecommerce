            ...
            <div class="widget-content widget-content-area">
                <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">نام روش پرداخت</label>
                            ...
                            <div class="form-group mb-4">
                                <label for="formGroupExampleInput">کد روش پرداخت</label>
                                <input type="text" class="form-control" name="merchent_id" wire:model='merchent_id' id="formGroupExampleInput">
                            </div>
                    ...
                    <button style="height: 50px" type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light">
                         <span wire:loading.remove >ثبت روش پرداخت</span>
