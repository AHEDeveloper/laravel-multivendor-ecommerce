            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-center">تصویر بند انگشتی</th>
                        <th scope="col" class="text-center">استوری</th>
                    ...
                    @foreach ($stories as $story)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="/stories/thumbnail/{{$story->thumbnail}}" width="100" height="100" alt="">
                            </td>

                            <td class="text-center">
                                <button data-story-title="{{ $story->name }}"
                                        data-story="/stories/story/{{ $story->story }}" type="button"
                                        class="btn btn-primary mr-2 _effect--ripple waves-effect waves-light text-center"
                            ...
                            <td class="text-center">
                                <div class="action-btns d-flex align-items-center">
                                    ...
                                    <div class="form-check form-check-primary form-check-inline ms-3">
                                        <input wire:confirm="آیا مطمئن هستید؟" wire:change="changeStatus({{$story->id}})"
