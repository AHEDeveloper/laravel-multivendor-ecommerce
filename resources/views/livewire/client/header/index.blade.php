        ...
        <div class="row gy-3 position-relative align-items-center"  >
            ...
            <div class="col-4 d-xl-none d-block order-xl-6">
                <div class="d-flex align-items-center me-2">
                    <div class="responsive-menu d-xl-none d-block">
                        <button aria-controls="responsiveMenu" class="btn border-0 p-0 btn-responsive-menu"
                        ...
                        <div aria-labelledby="responsiveMenu" class="offcanvas offcanvas-start" id="responsiveMenu" tabindex="-1">
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title" id="offcanvasRightLabel">فروشگاه آبتین</h5>
                            ...
                            <div class="offcanvas-body">
                                <a class="text-center top-header-logo d-block mb-3" href="">
                                    <img alt="" class="img-fluid" src="client/assets/image/logo.png">
                                </a>
                                <div class="header-bottom-form mb-4 w-100">
                                    <label class="d-block position-relative">
                                        <input type="text" class="form-control py-3 rounded-4 w-100 bs-bg-gray-100"
                                               placeholder="جستجوی محصول ...">
                                        <span class="position-absolute me-3 end-0 top-50 translate-middle-y"><i
                                                class="bi bi-search"></i></span>
                                    </label>
                                </div>
                                <ul class="rm-item-menu navbar-nav">
                                    <li class="nav-item bg-ul-f7"><a class="nav-link" href="">صفحه اصلی</a>
                                    </li>
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        @if(\Illuminate\Support\Facades\Auth::user())
                            <div class="radius-circle overflow-hidden d-flex" style="width: 30px;height: 30px">
                                <img class="object-fit-cover" src="/avatars/{{$user->id}}/{{@$user->cover->path}}" alt="">
                            </div>
                            <span class="fw-bold ms-1">خوش امدی {{\Illuminate\Support\Facades\Auth::user()->name}}</span>
                        @else
                            <i class="bi bi-person"></i>
                            <a href="{{route('client.auth.index')}}"><span class="fw-bold ms-1">وارد شوید</span></a>
                        @endif
                    </div>
                    <div class="pip mx-2"></div>
                    <nav class="navbar navbar-expand">
                        <ul class="navbar-nav header-navbar">
                            <li class="nav-item"><a href="{{route('client.home.index')}}"  class="nav-link font-12 bs-text-gray-600">صفحه اصلی</a></li>
                            <li class="nav-item">
                                @if(\Illuminate\Support\Facades\Auth::check())
                                    <a href="{{route('client.profile-information.index')}}"  class="nav-link font-11 bs-text-gray-600">حساب کابری</a>
                                @else
                                    <a href="{{route('client.auth.index')}}"  class="nav-link font-11 bs-text-gray-600">حساب کابری</a>
                                @endif
                            </li>
                            <li class="nav-item"><a href="{{route('client.shop.index')}}" class="nav-link font-12 bs-text-gray-600">فروشگاه</a></li>
                            <li class="nav-item"><a href="{{route('client.weblog.index')}}" class="nav-link font-12 bs-text-gray-600">مقالات</a>
                            </li>
                            <li class="nav-item">
                                @if(\Illuminate\Support\Facades\Auth::check())
                                    <a href="{{route('client.favorite.index')}}" class="nav-link font-12 bs-text-gray-600">علاقه مندی</a>
                                @else
                                    <a href="{{route('client.auth.index')}}"  class="nav-link font-11 bs-text-gray-600"> علاقه مندی</a>
                                @endif
                            </li>
                            <li class="nav-item"><a href="" class="nav-link font-12 bs-text-gray-600">سوالات متداول</a>
                            </li>
                            <li class="nav-item"><a href="" class="nav-link font-12 bs-text-gray-600">درباره ما</a></li>
                            <li class="nav-item"><a href="" class="nav-link font-12 bs-text-gray-600">تماس با ما</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="col-xl-4 order-xl-2 d-xl-block d-none">
                <div class="d-flex justify-content-end align-items-center">
                    <small class="text-muted font-12">هفت روز هفته، 24 ساعت شبانه‌روز پاسخگوی شما</small>
                    <div class="d-flex align-items-center ms-2">
                        <span class="fw-bold bs-text-red-600">12345678</span>
                        <span class="ms-1">021</span>
                    </div>
                </div>
            </div>
            <!-- logo -->
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <div class="text-end  add-to-cart-btn-parent">
                        <a data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart" class="btn btn-xl ms-3 rounded-4 font-16 bg-white border-1 focus-ring focus-ring-dark border-dark-subtle z-3">
                            ...
                            <span class="badge main-color-one-bg rounded-circle ms-2">1</span>
                        </a>
                    </div>
                </div>
            </div>
