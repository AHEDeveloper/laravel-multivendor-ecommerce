<div x-intersect="initializeSpecialOffersSlider">
    <section class="special-offers">
        <div class="container-fluid position-relative">
            ...
            <div class="special-offers-swiper" wire:ignore>
                <div class="swiper pro-slider" wire:ignore>
                    <div class="swiper-wrapper" wire:ignore>
                        @foreach($products as $product)
                            <div class="swiper-slide" wire:ignore>
                                <div class="product-box border-ui" wire:ignore>
                                    <div class="product-timer position-relative" wire:ignore>
                                        <div class="product-header-btn flex-column position-absolute top-0">
                                            ...
                                            <a href="javascript:void(0)" wire:click="compare({{$product->id}})" class="mb-1 border-ui" data-bs-toggle="tooltip"
                                               data-bs-placement="right"
                                    ...
                                    <a href="{{route('client.product.index',$product->p_code)}}/{{$product->seo->slug}}">
                                        ...
                                        <div class="bs-bg-gray-200 p-2 border-ui  rounded-3">
                                            ...
                                            <div class="progress bs-bg-gray-400 my-2" role="progressbar"
                                                 aria-label="Basic example" aria-valuenow="25" aria-valuemin="0"
                                                 aria-valuemax="100" style="height: 2px">
                                                <div class="progress-bar main-color-one-bg"
                                                     style="width: 25%"></div>
                                            </div>
