<div class="container-xl" style="margin-top: 100px;">
    <div class="row">
        ...
        <div class="col-3 text-right">
            <p class="text-end">شماره سفارش: ۱۲۳۴۵۶۷</p>
            <p class="text-end">تاریخ سفارش: ۱۳۹۹/۰۸/۰۸</p>
        </div>
    </div>
    <div class="row">
        <table class="table">
            ...
            <tr>
                <td colspan="11" class="text-right">
                    <div class="row">
                        <div class="col-4">
                            <p>نام شخص حقیق / حقوقی: راستچین</p>
                            <p>آدرس کامل: تهران، عباس آباد، خیابان سهروردی،کوچه عشوری</p>
                        </div>
                        <div class="col-4">
                            <p>شماره اقتصادی:</p>
                            <p>کد پستی:</p>
            ...
            <tr>
                <td colspan="11" class="text-right">
                    <div class="row">
                        <div class="col-4">
                            <p>نام شخص حقیق / حقوقی:امیر رضایی</p>
                            <p>آدرس کامل:</p>
                        </div>
                        <div class="col-4">
                            <p>شماره اقتصادی:</p>
            ...
            <tr>
                <th colspan="5" class="text-right">شرایط و نحوه فروش: نقدی
                    غیرنقدی
                </th>
