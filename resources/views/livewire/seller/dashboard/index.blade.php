                ...
                <ul class="navbar-nav flex-row ms-auto breadcrumb-action-dropdown">
                    <li class="nav-item more-dropdown">
                        <div class="dropdown  custom-dropdown-icon">
                            <a class="dropdown-toggle btn _effect--ripple waves-effect waves-light" href="#" role="button" id="customDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span>Settings</span>
    ...
    <div class="row layout-top-spacing">
            ...
            <div class="widget widget-activity-four">
                ...
                <div class="widget-content">
                    ...
                    <div class="tm-action-btn">
                        <button class="btn _effect--ripple waves-effect waves-light"><span>View All</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
            ...
            <div class="widget widget-wallet-one">
                ...
                <button class="btn btn-secondary w-100 mt-3 _effect--ripple waves-effect waves-light">View Transaction History</button>
