...
<link href="{{asset('/admin/src/bootstrap/css/bootstrap.rtl.min.css')}}" rel="stylesheet" type="text/css" />
...
<link href="{{asset('/admin/src/assets/css/light/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />
